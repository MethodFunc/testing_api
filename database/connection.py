...
SQLALCHEMY_DATABASE_URL1 = "postgresql+psycopg2://dev:dev123@127.0.0.1:5432/forecast"
SQLALCHEMY_DATABASE_URL2 = "postgresql+psycopg2://dev:dev123@127.0.0.1:5432/scada_data"
